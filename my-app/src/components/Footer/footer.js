...
export default function Footer() {
    return (
        <footer className="footer mt-5" style={{ backgroundColor: '#0b0b0b', color: '#fff' }}>
            <div className="container">
                ...
                <div className="col-md-4 mb-3">
                    ...
                    <li><a href="/html/lol-homepage.html" className="text-white text-decoration-none">Lộ Trình</a></li>
                    <li><a href="/html/valorant-homepage.html" className="text-white text-decoration-none">Lộ Trình Của Tôi</a></li>
                    <li><a href="/html/tft-homepage.html" className="text-white text-decoration-none">Về Chúng Tôi</a></li>
                    <li><a href="http://localhost:3000/login" className="text-white text-decoration-none">Đăng nhập</a></li>
                    </ul>
                </div>
